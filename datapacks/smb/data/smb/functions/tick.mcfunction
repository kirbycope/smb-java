...
execute as @a[scores={crouching=0,facing=0,jumping=0},tag=!intro,tag=!outro] run item replace entity @s armor.head with minecraft:leather_helmet
# Standing, looking left
execute as @a[scores={crouching=0,facing=1,jumping=0},tag=!intro,tag=!outro] run item replace entity @s armor.head with minecraft:chainmail_helmet
# Crouching, looking right
execute as @a[scores={crouching=1,facing=0},tag=!intro,tag=!outro] run item replace entity @s armor.head with minecraft:iron_helmet
# Crouching, looking left
execute as @a[scores={crouching=1,facing=1},tag=!intro,tag=!outro] run item replace entity @s armor.head with minecraft:golden_helmet
# Jumping, looking right
execute as @a[scores={crouching=0,facing=0,jumping=1},tag=!intro,tag=!outro] run item replace entity @s armor.head with minecraft:diamond_helmet
# Jumping, looking left
execute as @a[scores={crouching=0,facing=1,jumping=1},tag=!intro,tag=!outro] run item replace entity @s armor.head with minecraft:netherite_helmet
